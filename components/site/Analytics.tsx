...
/**
 * All trackers use strategy="lazyOnload" (injected after the window load
 * event) so they stay out of the critical path and don't regress
 * LCP/TBT on Lighthouse mobile.
 */
